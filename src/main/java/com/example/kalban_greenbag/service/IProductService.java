...
public interface IProductService extends IGenericService<ProductResponse>{
    ...
    PagingModel<ProductResponse> getProductByNameAndPriceRange(String name, BigDecimal minPrice, BigDecimal maxPrice,UUID baseModelId, Integer page, Integer limit) throws BaseException;
